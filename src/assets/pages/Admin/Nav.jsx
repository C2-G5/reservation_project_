      ...
      <div className="flex flex-wrap justify-between items-center">
        <div className="flex justify-start items-center">
          <button
            ...
            className="p-2 mr-2 text-[#5aa1c2] rounded-lg cursor-pointer md:hidden hover:text-[#222222] hover:bg-[#5aa1c2] focus:bg-[#5aa1c2] focus:text-[#222222] focus:ring-2 focus:ring-white"
          >
            <svg
              aria-hidden="true"
              className="w-6 h-6"
