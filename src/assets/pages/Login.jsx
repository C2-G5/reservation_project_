      ...
      <div className="w-full space-y-6 sm:max-w-md">
        <form action="" onSubmit={(e) => handleSubmit(e)}>
          <div className="max-w-sm w-full text-black border-2 border-gray-200 bg-white shadow p-5 py-6 sm:p-6 sm:rounded-lg ">
            ...
            <div>
              <button className="w-full flex items-center justify-center gap-x-3 py-2 border border-black rounded-lg text-sm font-medium hover:bg-black hover:text-white duration-150">
                <svg
                  className="w-5 h-5"
                  viewBox="0 0 48 48"
                  fill="none"
